...
.display{height:30px;letter-spacing:5px;margin-bottom:10px;}
</style>
</head>
...
<button onclick="clearPass()">X</button><button onclick="press(0)">0</button><button onclick="check()">✓</button>
</div>
</div>
